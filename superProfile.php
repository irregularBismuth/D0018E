...
$w=$sqlHandler->s->fetchAll();
    foreach($w as $w){
     ...
     echo "Alter username <form action='alterUser.php' method='post'><input type='text' name='uname' ><input type='hidden' name='hid' value=".$w['id']."><input type='submit' value='update username'></form></br>";
