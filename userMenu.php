...
<html>
    ...
    <body> 
        ...
        <ul>
            Items here....?
            <li>
            <?php echo '<img class="profileStyle" src="'.$userProfile->getSessionData()['profileImage'].' height=50 width=50" />'; ?>
                <ul>
        ...
        <?php                                          
            ...
            echo '<img class="profileStyle" src="'.$userProfile->getSessionData()['profileImage'].'"/>';    
