        ...
        <?php
            ...
            $count=$fetch_result->rowCount();
                ...
                # code...
                    ...
                    array_push($info_array,'<b>Animal type:</b> '.$query_output["animal_name"]."<br>"."<b>Price: </b> ".$query_output["animal_price"]."<br>"."<br> Description:</br> ".$query_output["animal_category"]);
