    ...
    <body>
        ...
        <?php
            ...
            $query_output = $fetch_result->fetchAll();
                ...
                # code...
               echo $query_output["animal_name"]."<img src=".$query_output['animal_image']."' width='".$width."' height='".$height."'>"."<br>".$query_output["animal_price"]."<br>".$query_output["animal_category"];
